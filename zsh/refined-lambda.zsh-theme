...
#PROMPT="%(?.%F{magenta}.%F{red})ヽ(^。^)ノ%f " # Display a red prompt char on failure
PROMPT="%(?.%F{magenta}.%F{red})•̀.̫•́✧%f " # Display a red prompt char on failure
#PROMPT="%(?.%F{magenta}.%F{red})\(^o^)/%f " # Display a red prompt char on failure
